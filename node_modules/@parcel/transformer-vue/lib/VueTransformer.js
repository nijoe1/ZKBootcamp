...
var _default = exports.default = new (_plugin().Transformer)({
  async loadConfig({
    ...
    let conf = await config.getConfig(['.vuerc', '.vuerc.json', '.vuerc.js', '.vuerc.cjs', '.vuerc.mjs', 'vue.config.js', 'vue.config.cjs', 'vue.config.mjs'], {
      packageKey: 'vue'
    });
    let contents = {};
    if (conf) {
...
function createDiagnostic(err, filePath) {
  ...
  let diagnostic = {
    ...
    codeFrames: err.loc ? [{
      filePath,
      codeHighlights: [(0, _diagnostic().convertSourceLocationToHighlight)(err.loc)]
    }] : []
  };
  return diagnostic;
}
